...
<html>
    ...
    <body>
        ...
        <form action="ServletControlador?accion=modificar&idCliente=${cliente.idCliente}"
            ...
            <jsp:include page="/paginas/comunes/BotonesEditarNavegacion.jsp" />
            <section id="details">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" name="saldo" 
                                               required step="any" value="${cliente.saldo}">
                                    </div>
